	...
	return (
		<div className="App">
			...
			<svg className="india-map">
				...
				<path
					fill={colorRange(
						stateData.length > 10 ? stateData[10].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 10
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 11 ? stateData[11].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 11
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 12 ? stateData[12].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 12
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 13 ? stateData[13].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 13
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 14 ? stateData[14].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 14
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 15 ? stateData[15].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 15
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 16 ? stateData[16].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 16
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 17 ? stateData[17].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 17
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 18 ? stateData[18].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 18
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 19 ? stateData[19].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 19
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 20 ? stateData[20].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 20
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 21 ? stateData[21].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 21
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 22 ? stateData[22].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 22
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 23 ? stateData[23].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 23
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 24 ? stateData[24].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 24
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 25 ? stateData[25].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 25
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 26 ? stateData[26].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 26
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 27 ? stateData[27].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 27
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 28 ? stateData[28].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 28
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 29 ? stateData[29].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 29
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 30 ? stateData[30].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 30
							? updateStateData(
									stateData[30].name,
									stateData[30].stateActive,
									stateData[30].stateRecovered,
									stateData[30].stateDeaths
							  )
							: updateStateData('', 0, 0, 0)
					}
					id="IN-SK"
				...
				<path
					fill={colorRange(
						stateData.length > 31 ? stateData[31].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 31
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 32 ? stateData[32].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 32
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 33 ? stateData[33].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 33
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 34 ? stateData[34].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 34
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 35 ? stateData[35].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 35
							? updateStateData(
				...
				<path
					fill={colorRange(
						stateData.length > 36 ? stateData[36].stateActive : 0
					)}
					onMouseEnter={() =>
						stateData.length > 36
							? updateStateData(
